...
ifeq ($(CONFIG_WLAN_GPIO_WAKEUP_LEGACY), y)
KBUILD_CPPFLAGS += -DWLAN_GPIO_WAKEUP_LEGACY
endif

ifeq ($(CONFIG_WLAN_GPIO_WAKEUP_GPIOD), y)
KBUILD_CPPFLAGS += -DWLAN_GPIO_WAKEUP_GPIOD
ifdef CONFIG_WLAN_GPIO_WAKEUP_GPIOD_CON_ID
KBUILD_CPPFLAGS += -DWLAN_GPIO_WAKEUP_GPIOD_CON_ID=\"$(CONFIG_WLAN_GPIO_WAKEUP_GPIOD_CON_ID)\"
endif
endif

ifeq ($(CONFIG_WLAN_GPIO_WAKEUP_OF_IRQ), y)
KBUILD_CPPFLAGS += -DWLAN_GPIO_WAKEUP_OF_IRQ
ifdef CONFIG_WLAN_GPIO_WAKEUP_OF_IRQ_NAME
KBUILD_CPPFLAGS += -DWLAN_GPIO_WAKEUP_OF_IRQ_NAME=\"$(CONFIG_WLAN_GPIO_WAKEUP_OF_IRQ_NAME)\"
endif
endif

ifeq ($(CONFIG_BLOCK_SIZE_FIX), y)
KBUILD_CPPFLAGS += -DBLOCK_SIZE_FIX
endif

ifeq ($(CONFIG_QCN_SDIO_OOB_IRQ), y)
KBUILD_CPPFLAGS += -DCONFIG_QCN_SDIO_OOB_IRQ
ifdef CONFIG_QCN_SDIO_OOB_GPIO_NUM
KBUILD_CPPFLAGS += -DQCN_SDIO_OOB_GPIO_NUM_DEFAULT=$(CONFIG_QCN_SDIO_OOB_GPIO_NUM)
endif
endif
...
GPIO_WAKEUP_OBJS := $(CNSS_DIR)/oob_wake.o
